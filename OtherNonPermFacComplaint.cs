...
namespace CID2
{
    public class OtherNonPermFacComplaint : OtherComplaint
    {
        ...
        public OtherNonPermFacComplaint() { }

        public OtherNonPermFacComplaint(int id, int subid, string typetable, NonPermittedFacLocation complaintaddress, Occupant occupant,
        ...
        public OtherNonPermFacComplaint(string facilityname, NonPermittedFacLocation complaintaddress, Complainant complainant,
        ...
        public OtherNonPermFacComplaint(OtherComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            OtherNonPermFacComplaint obj = new OtherNonPermFacComplaint(temp);
        ...
        public void RestoreOtherNonPermFacDataMembers(OtherNonPermFacComplaint comp)
        {
        ...
        public List<string> CompareOtherNonPermFacDataMembers(OtherNonPermFacComplaint comp, List<string> differenceList)
        {
    ...
    public class OtherNonPermFacList
    {
        private static List<OtherNonPermFacComplaint> OtherNonPerFacList = new List<OtherNonPermFacComplaint>();
        public static ListCollectionView OtherNonPermFacCollection = new ListCollectionView(OtherNonPerFacList);
    }
}
