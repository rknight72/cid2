...
namespace CID2
{
    public class ReleaseNonPermFacComplaint : ReleaseComplaint
    {
        ...
        public ReleaseNonPermFacComplaint() { }

        public ReleaseNonPermFacComplaint(int id, int subid, string typetable, NonPermittedFacLocation complaintaddress, Occupant occupant,
        ...
        public ReleaseNonPermFacComplaint(string facilityname, NonPermittedFacLocation complaintaddress, Complainant complainant,
        ...
        public ReleaseNonPermFacComplaint(ReleaseComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            ReleaseNonPermFacComplaint obj = new ReleaseNonPermFacComplaint(temp);
        ...
        public void RestoreReleaseNonPermFacDataMembers(ReleaseNonPermFacComplaint comp)
        {
        ...
        public List<string> CompareReleaseNonPermFacDataMembers(ReleaseNonPermFacComplaint comp, List<string> differenceList)
        {
    ...
    public class ReleaseNonPermFacList
    {
        private static List<ReleaseNonPermFacComplaint> ReleaseNonPerFacList = new List<ReleaseNonPermFacComplaint>();
        public static ListCollectionView ReleaseNonPermFacCollection = new ListCollectionView(ReleaseNonPerFacList);
    }
}
