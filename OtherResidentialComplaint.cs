...
namespace CID2
{
    public class OtherResidentialComplaint : OtherComplaint
    {
        ...
        public OtherResidentialComplaint() { }

        public OtherResidentialComplaint(int id, int subid, string typetable, ResidentialLocation complaintaddress, Occupant occupant,
        ...
        public OtherResidentialComplaint(string buildingdescription, ResidentialLocation complaintaddress,
        ...
        public OtherResidentialComplaint(OtherComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            OtherResidentialComplaint obj = new OtherResidentialComplaint(temp);
        ...
        public void RestoreOtherResDataMembers(OtherResidentialComplaint comp)
        {
        ...
        public List<string> CompareOtherResDataMembers(OtherResidentialComplaint comp, List<string> differenceList)
        {
    ...
    public class OtherResidentialList
    {
        private static List<OtherResidentialComplaint> OtherResList = new List<OtherResidentialComplaint>();
        public static ListCollectionView OtherResCollection = new ListCollectionView(OtherResList);
    }
}
