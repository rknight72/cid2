...
namespace CID2
{
    public class ReleaseOtherComplaint : ReleaseComplaint
    {
        public OtherLocation ComplaintAddress = new OtherLocation();

        public ReleaseOtherComplaint() { }

        public ReleaseOtherComplaint(int id, int subid, string typetable, OtherLocation complaintaddress,Complainant complainant,
            bool anonymous, string complainttext, string inspectionnotes, DateTime dateclosed, DateTime retentiondate, CETAtype ceta,
            string othernotes, user receivedby, user inspector, casestatus status, DateTime datereceived, DateTime incidentdate,
            ComplaintType type, DateTime lastmodified, receivedmethod methodreceived, DateTime investigateddate, bool appendixa, bool restricted)
        {
            ID = id;
            SubID = subid;
            TypeTable = typetable;
        ...
        public ReleaseOtherComplaint(OtherLocation complaintaddress, Complainant complainant, string complainttext, bool anonymous)
        {
            ComplaintAddress = complaintaddress;
            ComplaintAddress.SetOwner(this);
            ComplainantInfo = complainant;
        ...
        public ReleaseOtherComplaint(ReleaseComplaint comp)
        {
        ...
        {
            ReleaseComplaint temp = (ReleaseComplaint)base.MyClone();
            ReleaseOtherComplaint obj = new ReleaseOtherComplaint(temp);
        ...
        public void RestoreReleaseOtherDataMembers(ReleaseOtherComplaint comp)
        {
            ...
            RestoreReleaseDataMembers((ReleaseOtherComplaint)comp);

            return;
        }

        public List<string> CompareReleaseOtherDataMembers(ReleaseOtherComplaint comp, List<string> differenceList)
        {
            ...
            return CompareReleaseDataMembers((ReleaseComplaint)comp, returnList);
        }
    ...
    public class ReleaseOtherList
    {
        private static List<ReleaseOtherComplaint> ReleaseOthist = new List<ReleaseOtherComplaint>();
        public static ListCollectionView ReleaseOtherCollection = new ListCollectionView(ReleaseOthist);
    }
}
