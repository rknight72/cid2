...
namespace CID2
{
    public class ReleaseResidentialComplaint : ReleaseComplaint
    {
        ...
        public ReleaseResidentialComplaint() { }

        public ReleaseResidentialComplaint(int id, int subid, string typetable, ResidentialLocation complaintaddress, Occupant occupant,
        ...
        public ReleaseResidentialComplaint(string buildingdescription, ResidentialLocation complaintaddress,
        ...
        public ReleaseResidentialComplaint(ReleaseComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            ReleaseResidentialComplaint obj = new ReleaseResidentialComplaint(temp);
        ...
        public void RestoreReleaseResDataMembers(ReleaseResidentialComplaint comp)
        {
            ...
            RestoreReleaseDataMembers((ReleaseComplaint)comp);

            return;
        }

        public List<string> CompareReleaseResDataMembers(ReleaseResidentialComplaint comp, List<string> differenceList)
        {
        ...
        public override void SaveSubComplaint(OleDbCommand cidCMD)
        {
            ...
            if (SubID != 0)
            {
                strSQL = "UPDATE " + CompType.ComplaintTable + " SET pID = @pID, Site = @site, SiteName = @bldg WHERE pID = "
                    + ID.ToString() + ";";
            ...
            else
            {
                ...
                {
                    strSQL = "INSERT INTO " + CompType.ComplaintTable + " (pID, Site, SiteName) VALUES @pid, @site, @bldg)";
    ...
    public class ReleaseResidentialList
    {
        private static List<ReleaseResidentialComplaint> ReleaseResList = new List<ReleaseResidentialComplaint>();
        public static ListCollectionView ReleaseResCollection = new ListCollectionView(ReleaseResList);
    }
}
