...
namespace CID2
{
    public class ReleaseFacilityComplaint : ReleaseComplaint
    {
        ...
        public ReleaseFacilityComplaint() { }

        public ReleaseFacilityComplaint(int id, int subid, string typetable, Facility fac, FacilityContact faccontact, Complainant complainant,
        ...
        public ReleaseFacilityComplaint(Facility fac, Complainant complainant, string complainttext, bool anonymous)
        {
            ComplainantInfo = complainant;
            ComplainantInfo.SetOwner(this);
            ComplaintText = complainttext;
        ...
        public ReleaseFacilityComplaint(ReleaseComplaint comp)
        {
            ID = comp.ID;
        ...
        public override Object MyClone()
        {
            ...
            ReleaseFacilityComplaint obj = new ReleaseFacilityComplaint(temp);
        ...
        public void RestoreReleaseFacDataMembers(ReleaseFacilityComplaint comp)
        {
        ...
        public List<string> CompareReleaseFacDataMembers(ReleaseFacilityComplaint comp, List<string> differenceList)
        {
    ...
    public class ReleaseFacilityList
    {
        private static List<ReleaseFacilityComplaint> ReleaseFacList = new List<ReleaseFacilityComplaint>();
        public static ListCollectionView ReleaseFacCollection = new ListCollectionView(ReleaseFacList);
    }
}
