...
namespace CID2
{
    public class AsbestosOtherComplaint : AsbestosComplaint
    {
        public OtherLocation ComplaintAddress = new OtherLocation();
        public Owner Owner = new Owner();

        public AsbestosOtherComplaint() { }

        public AsbestosOtherComplaint(int id, int subid, string typetable, OtherLocation complaintaddress, Complainant complainant,
            bool anonymous, string complainttext, string inspectionnotes, string othernotes, user receivedby, user inspector,
            casestatus status, DateTime datereceived, DateTime incidentdate, DateTime dateclosed, DateTime retentiondate,
            CETAtype ceta, ComplaintType type, DateTime lastmodified, receivedmethod methodreceived, DateTime investigateddate,
            string antsid, bool appendixa, bool restricted)
        {
            ID = id;
            SubID = subid;
            TypeTable = typetable;
        ...
        public AsbestosOtherComplaint(OtherLocation complaintaddress, Complainant complainant, string complainttext, bool anonymous)
        {
            ComplaintAddress = complaintaddress;
            ComplaintAddress.SetOwner(this);
            ComplainantInfo = complainant;
        ...
        public AsbestosOtherComplaint(AsbestosComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            AsbestosOtherComplaint obj = new AsbestosOtherComplaint(temp);
        ...
        public void RestoreAsbestosOtherDataMembers(AsbestosOtherComplaint comp)
        {
        ...
        public List<string> CompareAsbestosOtherDataMembers(AsbestosOtherComplaint comp, List<string> differenceList)
        {
        ...
        public override void SaveSubComplaint(OleDbCommand cidCMD)
        {
            ...
            if (SubID != 0)
            {
                strSQL = "UPDATE " + CompType.ComplaintTable + " SET pID = @pID, ANTSID = @ants, Site = @site WHERE pID = " + ID.ToString() + ";";
            ...
            else
            {
                ...
                {
                    strSQL = "INSERT INTO " + CompType.ComplaintTable + " (pID, ANTSID, Site) VALUES (@pid, @ants, @site)";
    ...
    public class AsbestosOtherList
    {
        private static List<AsbestosOtherComplaint> AsbestosOthList = new List<AsbestosOtherComplaint>();
        public static ListCollectionView AsbestosOtherCollection = new ListCollectionView(AsbestosOthList);
    }
}
