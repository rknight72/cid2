...
namespace CID2
{
    ...
    /// </summary>
    public partial class SiteControlNonPermFac : SiteControlBase
    {
        public new NonPermittedFacLocation ControlOwner { get; set; }

        public SiteControlNonPermFac()
        {
            InitializeComponent();
            InitializeControls();
        }

        public SiteControlNonPermFac(NonPermittedFacLocation owner)
        {
            ControlOwner = owner;
        ...
        {
            NonPermFacSearch search = new NonPermFacSearch(LoadNewAddress);
