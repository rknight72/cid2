...
namespace CID2
{
    public class OBFacilityComplaint : OBComplaint
    {
        ...
        public OBFacilityComplaint() { }

        public OBFacilityComplaint(int id, int subid, string typetable, Facility fac, FacilityContact faccontact, Complainant complainant,
            bool anonymous, FireDepartment fdinfo, bool fdgenerated, string complainttext, string inspectionnotes, string othernotes,
            ...
            DateTime dateinvestigated, bool appendixa, bool restricted, string facilityname, OtherLocation portablelocation)
        {
            ID = id;
            SubID = subid;
            TypeTable = typetable;
        ...
        public OBFacilityComplaint(Facility fac, Complainant complainant, string complainttext, bool anonymous, bool fdgenerated)
        {
            ComplainantInfo = complainant;
            ComplainantInfo.SetOwner(this);
            ComplaintText = complainttext;
        ...
        public OBFacilityComplaint(OBComplaint comp)
        {
            ID = comp.ID;
        ...
        public override Object MyClone()
        {
            ...
            OBFacilityComplaint obj = new OBFacilityComplaint(temp);
        ...
        public void RestoreOBFacDataMembers(OBFacilityComplaint comp)
        {
        ...
        public List<string> CompareOBFacDataMembers(OBFacilityComplaint comp, List<string> differenceList)
        {
        ...
        public override void SaveSubComplaint(OleDbCommand cidCMD)
        {
            ...
            if (SubID != 0)
            {
                strSQL = "UPDATE " + CompType.ComplaintTable + " SET Site = @fid, PrimaryContact = @cid, Fire_Dept_Generated = @fdgen, "
                + "Fire_Department = @fd, SiteName = @facname, PortableSite = @portable, pID = @pID WHERE pID = " + ID.ToString() + ";";
            ...
            else
            {
                ...
                {
                    strSQL = "INSERT INTO " + CompType.ComplaintTable + " (Site, PrimaryContact, Fire_Dept_Generated, Fire_Department, SiteName, PortableSite, pID) "
                    + "VALUES (@fid, @cid, @fdgen, @fd, @facname, @portable, @pid)";
        ...
        { if (ContactControl.thisContact != null && ContactControl.thisContact != null) ContactControl.thisContact.SaveContact(cidCMD, ID); }
    ...
    public class OBFacilityList
    {
        private static List<OBFacilityComplaint> OBFacList = new List<OBFacilityComplaint>();
        public static ListCollectionView OBFacCollection = new ListCollectionView(OBFacList);
    }
}
