...
namespace CID2
{
    public class OdorResidentialComplaint : OdorComplaint
    {
        ...
        public OdorResidentialComplaint() { }

        public OdorResidentialComplaint(int id, int subid, string typetable, ResidentialLocation complaintaddress, Occupant occupant,
        ...
        public OdorResidentialComplaint(string buildingdescription, ResidentialLocation complaintaddress,
        ...
        public OdorResidentialComplaint(OdorComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            OdorResidentialComplaint obj = new OdorResidentialComplaint(temp);
        ...
        public void RestoreOdorResDataMembers(OdorResidentialComplaint comp)
        {
        ...
        public List<string> CompareOdorResDataMembers(OdorResidentialComplaint comp, List<string> differenceList)
        {
    ...
    public class OdorResidentialList
    {
        private static List<OdorResidentialComplaint> OdorResList = new List<OdorResidentialComplaint>();
        public static ListCollectionView OdorResCollection = new ListCollectionView(OdorResList);
    }
}
