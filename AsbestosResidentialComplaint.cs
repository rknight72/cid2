...
namespace CID2
{
    public class AsbestosResidentialComplaint : AsbestosComplaint
    {
        ...
        public AsbestosResidentialComplaint() { }

        public AsbestosResidentialComplaint(int id, int subid, string typetable, ResidentialLocation complaintaddress, Owner owner,
            ...
            OtherOperator otheroperator, Complainant complainant, bool anonymous, string complainttext, string inspectionnotes,
            string othernotes, user receivedby, user inspector, casestatus status, DateTime datereceived, DateTime incidentdate,
            DateTime dateclosed, DateTime retentiondate, CETAtype ceta, ComplaintType type, DateTime lastmodified, receivedmethod methodreceived,
            DateTime investigateddate, string antsid, bool appendixa, bool restricted, string buildingdescription)
        {
            ID = id;
            SubID = subid;
            TypeTable = typetable;
        ...
        public AsbestosResidentialComplaint(string buildingdescription, ResidentialLocation complaintaddress, Complainant complainant,
        ...
        public AsbestosResidentialComplaint(AsbestosComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            AsbestosResidentialComplaint obj = new AsbestosResidentialComplaint(temp);
        ...
        public void RestoreAsbestosResDataMembers(AsbestosResidentialComplaint comp)
        {
        ...
        public List<string> CompareAsbestosResDataMembers(AsbestosResidentialComplaint comp, List<string> differenceList)
        {
        ...
        public override void SaveSubComplaint(OleDbCommand cidCMD)
        {
            ...
            if (SubID != 0)
            {
                strSQL = "UPDATE " + CompType.ComplaintTable + " SET pID = @pID, ANTSID = @ants, Site = @site, SiteName = @bldg WHERE pID = "
                    + ID.ToString() + ";";
            ...
            else
            {
                ...
                {
                    strSQL = "INSERT INTO " + CompType.ComplaintTable + " (pID, ANTSID, Site, SiteName) VALUES @pid, @ants, @site, @bldg)";
    ...
    public class AsbestosResidentialList
    {
        private static List<AsbestosResidentialComplaint> AsbestosResList = new List<AsbestosResidentialComplaint>();
        public static ListCollectionView AsbestosResCollection = new ListCollectionView(AsbestosResList);
    }
}
