...
namespace CID2
{
    public class NonPermittedFacLocation : ComplaintAddress
    {
        public string PlaceID { get; set; }
        public SiteControlNonPermFac SiteControl { get; set; }

        public NonPermittedFacLocation()
        {
            PlaceID = "";
            SiteControl = new SiteControlNonPermFac(this);
        }

        public NonPermittedFacLocation(int id, string placeid, string addressline1, string addressline2, city city,
        ...
        public override void UpdateSiteControlContent()
        {
            ...
            else SiteControl.cboZipBox.SelectedIndex = 0;
        ...
        public void SaveComplaintSite(OleDbCommand cidCMD)
        {
            ...
            else
            {
                ...
                strSQL = "UPDATE " + Owner.TypeTable + " SET Site = @facID WHERE (ID = @subid);";
