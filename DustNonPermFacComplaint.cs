...
namespace CID2
{
    public class DustNonPermFacComplaint : DustComplaint
    {
        ...
        public DustNonPermFacComplaint() { }

        public DustNonPermFacComplaint(int id, int subid, string typetable, NonPermittedFacLocation complaintaddress, Occupant occupant,
        ...
        public DustNonPermFacComplaint(string facilityname, NonPermittedFacLocation complaintaddress, Complainant complainant,
        ...
        public DustNonPermFacComplaint(DustComplaint comp)
        {
        ...
        public override void SetParcelInfo(string parcel, string owner, string zip)
        {
            if (parcel != "") ComplaintAddress.Parcel = parcel;
            if (owner != "") Owner.FName = owner;
            if (zip != "") ComplaintAddress.Zip = zip;
        ...
        public override Object MyClone()
        {
            ...
            DustNonPermFacComplaint obj = new DustNonPermFacComplaint(temp);
            ...
            if (Occupant != null && Occupant.ID != 0)
            {
                ...
                obj.Occupant.thisControl = Occupant.thisControl;
                obj.Occupant.SetOwner(this);
            }
            else obj.Occupant = new Occupant(Occupant.thisControl, this);
            ...
            if (Owner != null && Owner.ID != 0)
            {
                ...
                obj.Owner.thisControl = Owner.thisControl;
                obj.Owner.SetOwner(this);
            }
            else obj.Owner = new Owner(Owner.thisControl, this);

            return obj;
        }

        public void RestoreDustNonPermFacDataMembers(DustNonPermFacComplaint comp)
        {
        ...
        public List<string> CompareDustNonPermFacDataMembers(DustNonPermFacComplaint comp, List<string> differenceList)
        {
    ...
    public class DustNonPermFacList
    {
        private static List<DustNonPermFacComplaint> DustNonPerFacList = new List<DustNonPermFacComplaint>();
        public static ListCollectionView DustNonPermFacCollection = new ListCollectionView(DustNonPerFacList);
    }
}
