...
namespace CID2
{
    ...
    /// </summary>
    public partial class SiteControlOther : SiteControlBase
    {
        public new OtherLocation ControlOwner { get; set; }

        public SiteControlOther()
        {
            InitializeComponent();
            InitializeControls();
        }

        public SiteControlOther(OtherLocation owner)
        {
            ControlOwner = owner;
