...
namespace CID2
{
    public class OtherOperator : Contact
    {
        public OtherOperatorControl thisControl { get; set; }
        ...
        public OtherOperator()
        {
            ...
            thisControl = new OtherOperatorControl(this);
        }

        public OtherOperator(Complaint owner)
        { Owner = owner; }

        public OtherOperator(OtherOperatorControl control, Complaint owner)
        {
            thisControl = control;
            Owner = owner;
        }

        public OtherOperator(Contact contact)
        {
            ID = contact.ID;
            FName = contact.FName;
            LName = contact.LName;
        ...
        public OtherOperator(int id, string firstname, string lastname, string addressline1, string addressline2,
