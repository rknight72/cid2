...
namespace CID2
{
    public class OdorFacilityComplaint : OdorComplaint
    {
        ...
        public OdorFacilityComplaint() { }

        public OdorFacilityComplaint(int id, int subid, string typetable, Facility fac, FacilityContact faccontact, Complainant complainant,
        ...
        public OdorFacilityComplaint(Facility fac, Complainant complainant, string complainttext, bool anonymous)
        {
            ComplainantInfo = complainant;
            ComplainantInfo.SetOwner(this);
            ComplaintText = complainttext;
        ...
        public OdorFacilityComplaint(OdorComplaint comp)
        {
            ID = comp.ID;
        ...
        public override Object MyClone()
        {
            ...
            OdorFacilityComplaint obj = new OdorFacilityComplaint(temp);
            ...
            if (FacilityControl != null && FacilityControl.thisFacility.ID != 0)
            {
                ...
                obj.FacilityControl = new SiteControlFacility(this, f);
            }
        ...
        public void RestoreOdorFacDataMembers(OdorFacilityComplaint comp)
        {
        ...
        public List<string> CompareOdorFacDataMembers(OdorFacilityComplaint comp, List<string> differenceList)
        {
    ...
    public class OdorFacilityList
    {
        private static List<OdorFacilityComplaint> OdorFacList = new List<OdorFacilityComplaint>();
        public static ListCollectionView OdorFacCollection = new ListCollectionView(OdorFacList);
    }
}
