...
namespace CID2
{
    public class OtherOtherComplaint : OtherComplaint
    {
        public OtherLocation ComplaintAddress = new OtherLocation();

        public OtherOtherComplaint() { }

        public OtherOtherComplaint(int id, int subid, string typetable, OtherLocation complaintaddress, Complainant complainant, bool anonymous,
        ...
        public OtherOtherComplaint(OtherLocation complaintaddress, Complainant complainant, string complainttext, bool anonymous)
        {
            ComplaintAddress = complaintaddress;
            ComplaintAddress.SetOwner(this);
            ComplainantInfo = complainant;
        ...
        public OtherOtherComplaint(OtherComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            OtherOtherComplaint obj = new OtherOtherComplaint(temp);
        ...
        public void RestoreOtherResDataMembers(OtherOtherComplaint comp)
        {
            ...
            RestoreOtherDataMembers((OtherOtherComplaint)comp);

            return;
        }

        public List<string> CompareOtherOtherDataMembers(OtherOtherComplaint comp, List<string> differenceList)
        {
    ...
    public class OtherOtherList
    {
        private static List<OtherOtherComplaint> OtherOthist = new List<OtherOtherComplaint>();
        public static ListCollectionView OtherOtherCollection = new ListCollectionView(OtherOthist);
    }
}
