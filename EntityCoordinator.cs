...
namespace CID2
{
    public class EntityCoordinator : Contact
    {
        public EntityCoordinatorControl thisControl { get; set; }
        ...
        public EntityCoordinator()
        {
            ...
            thisControl = new EntityCoordinatorControl(this);
        }

        public EntityCoordinator(Complaint owner)
        { Owner = owner; }

        public EntityCoordinator(EntityCoordinatorControl control, Complaint owner)
        {
            thisControl = control;
            Owner = owner;
        }

        public EntityCoordinator(int id, string firstname, string lastname, string addressline1, string addressline2,
        ...
        public EntityCoordinator(Contact contact)
        {
            ID = contact.ID;
            FName = contact.FName;
            LName = contact.LName;
