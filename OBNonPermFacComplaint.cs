...
namespace CID2
{
    public class OBNonPermFacComplaint : OBComplaint
    {
        ...
        public OBNonPermFacComplaint() { }

        public OBNonPermFacComplaint(int id, int subid, string typetable, NonPermittedFacLocation complaintaddress, Occupant occupant,
            ...
            receivedmethod methodreceived, DateTime investigateddate, bool appendixa, bool restricted, string facilityname)
        {
            ID = id;
            SubID = subid;
            TypeTable = typetable;
        ...
        public OBNonPermFacComplaint(string facilityname, NonPermittedFacLocation complaintaddress, Complainant complainant,
            string complainttext, bool anonymous, bool fdgenerated)
        {
            FacilityName = facilityname;
            ComplaintAddress = complaintaddress;
            ComplaintAddress.SetOwner(this);
        ...
        public OBNonPermFacComplaint(OBComplaint comp)
        {
        ...
        public override Object MyClone()
        {
            ...
            OBNonPermFacComplaint obj = new OBNonPermFacComplaint(temp);
        ...
        public void RestoreOBNonPermFacDataMembers(OBNonPermFacComplaint comp)
        {
        ...
        public List<string> CompareOBNonPermFacDataMembers(OBNonPermFacComplaint comp, List<string> differenceList)
        {
        ...
        public override void SaveSubComplaint(OleDbCommand cidCMD)
        {
            ...
            if (SubID != 0)
            {
                ...
                + "Site = @site, SiteName = @facname WHERE pID = " + ID.ToString() + ";";
            ...
            else
            {
                ...
                else
                {
                    ...
                    + " VALUES (@fdgen, @fd, @pid, @site, @facname)";
    ...
    public class OBNonPermFacilityList
    {
        private static List<OBNonPermFacComplaint> OBNonPermFacList = new List<OBNonPermFacComplaint>();
        public static ListCollectionView OBNonPermFacCollection = new ListCollectionView(OBNonPermFacList);
    }
}
