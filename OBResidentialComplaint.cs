...
namespace CID2
{
    public class OBResidentialComplaint : OBComplaint
    {
        ...
        public OBResidentialComplaint() { }

        public OBResidentialComplaint(int id, int subid, string typetable, ResidentialLocation complaintaddress, Occupant occupant,
            Owner owner, Complainant complainant, bool anonymous, FireDepartment fdinfo, bool fdgenerated, string complainttext,
            string inspectionnotes, string othernotes, user receivedby, user inspector, casestatus status, DateTime datereceived,
            DateTime incidentdate, DateTime dateclosed, DateTime retentiondate, CETAtype ceta, ComplaintType type, DateTime lastmodified,
            receivedmethod methodreceived, DateTime investigateddate, bool appendixa, bool restricted, string buildingdescription)
        {
            ID = id;
            SubID = subid;
            TypeTable = typetable;
        ...
        public OBResidentialComplaint(string buildingdescription, ResidentialLocation complaintaddress,
            Complainant complainant, string complainttext, bool anonymous, bool fdgenerated)
        {
            BuildingDescription = buildingdescription;
            ComplaintAddress = complaintaddress;
            ComplaintAddress.SetOwner(this);
        ...
        public OBResidentialComplaint(OBComplaint comp)
        {
            ...
            FDinfo = (comp.FDinfo != null && comp.FDinfo.ID != 0) ? comp.FDinfo : new FireDepartment(); 
            Status = comp.Status;
        ...
        public override Object MyClone()
        {
            ...
            OBResidentialComplaint obj = new OBResidentialComplaint(temp);
        ...
        public void RestoreOBResDataMembers(OBResidentialComplaint comp)
        {
        ...
        public List<string> CompareOBResDataMembers(OBResidentialComplaint comp, List<string> differenceList)
        {
        ...
        public override void SaveSubComplaint(OleDbCommand cidCMD)
        {
            ...
            if (SubID != 0)
            {
                strSQL = "UPDATE " + CompType.ComplaintTable + " SET Fire_Dept_Generated = @fdgen, Fire_Department = @fd, pID = @pID, "
                + "Site = @site, SiteName = @bldg WHERE pID = " + ID.ToString() + ";";
            ...
            else
            {
                ...
                {
                    strSQL = "INSERT INTO " + CompType.ComplaintTable + " (Fire_Dept_Generated, Fire_Department, pID, Site, SiteName) "
                    + "VALUES (@fdgen, @fd, @pid, @site, @bldg)";
        ...
        public override void ExecuteSubTypeSQL(out OleDbCommand cidCMD, string strSQL)
        {
            ...
            cidCMD.Parameters.Add("@bldg", OleDbType.BSTR).Value = (BuildingDescription != null) ? BuildingDescription : "";
            cidCMD.ExecuteNonQuery();
        }
    ...
    public class OBResidentialList
    {
        private static List<OBResidentialComplaint> OBResList = new List<OBResidentialComplaint>();
        public static ListCollectionView OBResCollection = new ListCollectionView(OBResList);
    }
}
