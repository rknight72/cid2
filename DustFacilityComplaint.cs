...
namespace CID2
{
    public class DustFacilityComplaint : DustComplaint
    {
        ...
        public DustFacilityComplaint() { }

        public DustFacilityComplaint(int id, int subid, string typetable, Facility fac, FacilityContact faccontact, Complainant complainant,
        ...
        public DustFacilityComplaint(Facility fac, Complainant complainant, string complainttext, bool anonymous)
        {
            ComplainantInfo = complainant;
            ComplainantInfo.SetOwner(this);
            ComplaintText = complainttext;
        ...
        public DustFacilityComplaint(DustComplaint comp)
        {
            ID = comp.ID;
        ...
        public override Object MyClone()
        {
            ...
            DustFacilityComplaint obj = new DustFacilityComplaint(temp);
        ...
        public void RestoreDustFacDataMembers(DustFacilityComplaint comp)
        {
        ...
        public List<string> CompareDustFacDataMembers(DustFacilityComplaint comp, List<string> differenceList)
        {
    ...
    public class DustFacilityList
    {
        private static List<DustFacilityComplaint> DustFacList = new List<DustFacilityComplaint>();
        public static ListCollectionView DustFacCollection = new ListCollectionView(DustFacList);
    }
}
